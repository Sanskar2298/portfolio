  ...
  return (
    <footer className="border-t border-border px-6 py-10">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        <a
          href="#"
          className="font-display font-semibold text-text-primary hover:text-accent transition-colors"
        >
        ...
        <div className="flex items-center gap-4">
          {socials.map((s) => (
            <a
              ...
              aria-label={s.label}
              className="w-8 h-8 rounded-lg border border-border hover:border-accent/40 flex items-center justify-center text-text-dim hover:text-accent-soft transition-all duration-200"
            >
              {s.icon}
            </a>
          ))}
        ...
        <motion.button
          ...
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.95 }}
          className="w-8 h-8 rounded-lg border border-border hover:border-accent/40 flex items-center justify-center text-text-dim hover:text-accent transition-all duration-200"
